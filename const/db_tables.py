...
tables_list[tables_count][1]=[	'video_id_part',						# 用于查询定位video_id中video part的数值，32位二进制唯一识别编码，以0x开头8位十六进制表示，以文本形式存储
								...
								'video_ass_index',
								'video_ass_codec_name',
								'video_ass_codec_long_name',
								'video_ass_codec_type',
								'video_ass_codec_tag_string',
								'video_ass_codec_tag',
								'video_ass_r_frame_rate',
								'video_ass_avg_frame_rate',
								'video_ass_time_base',
								'video_ass_start_pts',
								'video_ass_start_time',
								'video_ass_duration_ts',
								'video_ass_duration',
								'video_ass_extradata_size',
								'video_ass_disposition',
								'video_ass_tags',
								#------------以下不是字段，是设置主键和外键的信息------------
...
tables_list[tables_count][2]=[	'TEXT',									# 'video_id_part'
								...
								'TEXT',									# 'video_a_tags',
								#------------以下字段为ffmpeg.probe['streams']字幕频流中第一个字幕流提供的字段信息------------
								'INTEGER',								# 'video_ass_index',
								'TEXT',									# 'video_ass_codec_name',
								'TEXT',									# 'video_ass_codec_long_name',
								'TEXT',									# 'video_ass_codec_type',
								'TEXT',									# 'video_ass_codec_tag_string',
								'TEXT',									# 'video_ass_codec_tag',
								'TEXT',									# 'video_ass_r_frame_rate',
								'TEXT',									# 'video_ass_avg_frame_rate',
								'TEXT',									# 'video_ass_time_base',
								'TEXT',									# 'video_ass_start_pts',
								'TEXT',									# 'video_ass_start_time',
								'INTEGER',								# 'video_ass_duration_ts',
								'TEXT',									# 'video_ass_duration',
								'TEXT',									# 'video_v_nb_frames',
								'INTEGER',								# 'video_ass_extradata_size',
								'TEXT',									# 'video_ass_disposition',
								'TEXT',									# 'video_ass_tags',
								#------------以下不是字段，是设置主键和外键的信息------------
							  	'',																					## 设置主键
